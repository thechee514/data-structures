...
public class Testing {
    ...
    private static int NUM_FAILS = 0;
    ...
    public static void assertEquals(String message, 
                                    ...
                                    String[] actual)
    {
        printTestCaseInfo(message, arrayToString(expected), arrayToString(actual));
    ...
    {
        System.out.println("Finished " + NUM_TESTS + " test(s) with " + NUM_FAILS + " failure(s).");
    }
}
