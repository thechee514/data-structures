/**
 * Sorts items using a PQ. The primary method is priorityQueueSort which takes a
 * heap for use in the PQ.
 * 
...
public class Sorter
{
    ...
    /**
     * Sorts the elements in the heap. This is pretty easy if you use a priority
     * queue. Just make a PQ out of the heap and then remove all of the items
     * (since they'll come out in sorted order)!
     * 
     * @param array
     *            the heap to sort.
     */
