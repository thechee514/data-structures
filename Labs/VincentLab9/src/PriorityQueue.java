 ...
 * constructor to create an empty PQ and an insert method. In this version, a PQ
 * can only be created by giving it a ready-made heap. This PQ only handles
 * ints.
 * 
...
public class PriorityQueue
{
     ...
     * 
     * @param initialValues
     *            the array of values contained in the priority queue.
     */
